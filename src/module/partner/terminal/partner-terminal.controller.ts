...
@Controller() @ApiTags('terminal') @ApiBearerAuth() @ApiHeader(Const.SWAGGER_LANGUAGE_HEADER) @ApiHeader(Const.SWAGGER_AUTHORIZATION_HEADER)
export class PartnerTerminalController {
    ...
    @Delete(':id') @Roles(RoleType.TERMINAL) @UseGuards(JwtAuthGuard, RolesGuard)
