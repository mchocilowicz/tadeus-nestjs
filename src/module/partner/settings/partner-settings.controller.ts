...
@Controller() @ApiTags('settings') @ApiBearerAuth() @ApiHeader(Const.SWAGGER_LANGUAGE_HEADER) @ApiHeader(Const.SWAGGER_AUTHORIZATION_HEADER)
export class PartnerSettingsController {
    ...
    @Put() @Roles(RoleType.TERMINAL) @UseGuards(JwtAuthGuard, RolesGuard)
